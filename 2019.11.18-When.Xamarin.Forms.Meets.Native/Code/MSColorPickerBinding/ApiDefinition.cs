...
namespace MSColorPicker
{
    ...
    {
        // extern const CGFloat MSRGBColorComponentMaxValue;
        [Field("MSRGBColorComponentMaxValue", "__Internal")]
        nfloat MSRGBColorComponentMaxValue { get; }

        // extern const CGFloat MSAlphaComponentMaxValue;
        [Field("MSAlphaComponentMaxValue", "__Internal")]
        nfloat MSAlphaComponentMaxValue { get; }

        // extern const CGFloat MSHSBColorComponentMaxValue;
        [Field("MSHSBColorComponentMaxValue", "__Internal")]
        nfloat MSHSBColorComponentMaxValue { get; }
    }
    ...
    */
    ...
    {
        [Wrap("WeakDelegate")]
        IMSColorViewDelegate Delegate { get; set; }
    ...
    interface IMSColorViewDelegate { }
